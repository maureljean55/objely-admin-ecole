...
export function explain(error: DbError): string {
  ...
  if (/set_kiosk_paused/.test(msg) && /function|schema cache/i.test(msg)) return "La mise en pause des bornes n'est pas encore disponible. Réessayez un peu plus tard.";
